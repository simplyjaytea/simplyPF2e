...
**Published baseline:** PR #107 (source `bfd698d4733ee45ff414049b0ee74acf58a2aef`) merged as `16f9745282c44f306071e0b81e43ba05186830e9` and released **v0.3.5.67** after CI 34238059322 and Auto Release 34238176018 succeeded. Setup installed the exact .67 release and the existing test world was rejoined as GM; Foundry 14.365, PF2e 8.5.0, provider settings, and world data were preserved. No .67 generation acceptance is claimed yet. Detailed evidence and acceptance limits are in [docs/consumer-readiness-2026-09-08.md](docs/consumer-readiness-2026-09-08.md). Git remains authoritative; [HANDOFF.md](HANDOFF.md) tracks current work and [HISTORY.md](HISTORY.md) holds prior evidence.
...
**Latest installed .67 acceptance:** enforced empty creature equipment/treasure, ABC selection, initial busy rendering, independent Forge cancellation and native charm activation/depletion/rest passed. Fighter reached creation but rolled back on the consumed kit expectation; its preview also retained duplicated currency despite zero remaining budget. The native kit and currency fixes are independently Astra-approved on `codex/consumer-native-completion` and await publication/update. Exact narrative fidelity, remaining supported-PC/encounter coverage and duplicate-copy activation remain acceptance limits.
