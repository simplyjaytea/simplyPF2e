...
**Published baseline:** PR #108 (source `ee52c91471fe87fa3ca80e11246ec161b9d1649e`) merged as `425e9339faf0a6b52099fa63c42fb2600b9986ee` and released **v0.3.5.68** after CI 34241316182 and Auto Release 34241400856 succeeded. Setup installed the exact .68 release and the existing test world was rejoined as GM; Foundry 14.365, PF2e 8.5.0, provider settings, and world data were preserved. Native .68 QA records bounded Fighter, Investigator-path, and one-member encounter results; a focused Rogue retry failed closed, and broader coverage remains open. This is an audited, released baseline for GM-reviewed use along exercised paths, not blanket complete acceptance of every requested PC. Detailed evidence and limits are in [docs/consumer-readiness-2026-09-08.md](docs/consumer-readiness-2026-09-08.md). Git remains authoritative; [HANDOFF.md](HANDOFF.md) tracks current work and [HISTORY.md](HISTORY.md) holds prior evidence.
