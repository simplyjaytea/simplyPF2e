...
**Published baseline:** PR #105 merged at `ee584e2` and released **v0.3.5.65**. Foundry Setup updated only SimplyPF2e to that version and the existing test world was relaunched on Foundry 14.365 / PF2e 8.5.0. Follow-up live QA is on `codex/consumer-live-qa`. Detailed evidence and acceptance limits are in [docs/consumer-readiness-2026-09-08.md](docs/consumer-readiness-2026-09-08.md). Git remains authoritative; [HANDOFF.md](HANDOFF.md) tracks current work and [HISTORY.md](HISTORY.md) holds prior evidence.
