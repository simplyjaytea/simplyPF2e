...
**Published baseline:** PR #109 (final source `165d25e551408af8e1a40910d18ea2a97396c586`) merged as `dcd19fdd816ccaa6ca04efb0b3655127c654178e` after CI 34245166276 succeeded. Auto Release 34245250286 published **v0.3.5.69** with both assets. Setup updated only SimplyPF2e to .69; the existing test world was rejoined as GM and its Generator/provider controls passed a smoke check without provider spend. Foundry 14.365, PF2e 8.5.0 and world/provider data were preserved. The .68 native Fighter, Investigator-path and small encounter results remain version-specific; Rogue and exact requested-PC fidelity did not pass. This is a released baseline for GM-reviewed use, not blanket complete requested-PC acceptance. Detailed evidence is in [docs/consumer-readiness-2026-09-08.md](docs/consumer-readiness-2026-09-08.md); [HANDOFF.md](HANDOFF.md) tracks the next step.
...
- **NPC feat compatibility:** The implementation branch uses source-backed ability packages that clone complete verified dependency graphs and stage native grants after baseline actor creation. Stunning Blows supports its verified Flurry source, NPC class-DC bridge, and unarmed support. Crane Stance (`Strike.replaceAll`), Deflect Projectile's hands-free predicate, and arbitrary class resources/choices remain fail-closed. Failed cleanup reports a surviving incomplete actor and prevents duplicate retry. All slices have independent Astra approval; 88 regressions and 124 syntax checks pass. Publication and live Foundry acceptance remain pending. See [NPC feat plan](docs/npc-feat-plan-2026-09-09.md) and [automatic ability implementation record](docs/npc-automatic-abilities-2026-09-09.md).
