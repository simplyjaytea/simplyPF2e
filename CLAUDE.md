...
**Published baseline:** PR #102 merged at `7f8558e`; the GitHub API confirms **v0.3.5.62** with both module assets. It includes the Item Forge directory row and exclusive kind-action tiles. Git remains authoritative for branch state; [HANDOFF.md](HANDOFF.md) tracks current local work and outstanding acceptance, and [HISTORY.md](HISTORY.md) holds prior release/review evidence.
