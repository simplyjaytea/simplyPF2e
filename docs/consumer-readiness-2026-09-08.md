...
4. **Acceptance and publication.** Local regressions and browser layout checks pass. PR #105 merged at `ee584e2`; PR checks (34231115320) and Auto Release (34231202994) succeeded, publishing v0.3.5.65 with `module.json` and `module.zip`. PR #106 then published .66, and PR #107 (source `bfd698d4733ee45ff414049b0ee74acf58a2aef`, merged as `16f9745282c44f306071e0b81e43ba05186830e9`) published **v0.3.5.67** after CI 34238059322 and Auto Release 34238176018 succeeded. Setup installed exact .67 and the existing test world was rejoined as GM; installed checks are recorded separately below.
...
The module-only updates to **0.3.5.65**, **0.3.5.66**, and **0.3.5.67** are verified in Setup; **.67 is the latest installed baseline**. Setup installed the exact .67 release and the existing `test` world was rejoined as GM. Foundry remains **14.365**, PF2e remains **8.5.0**, and the existing world and provider settings are preserved. No .67 generation acceptance is claimed yet.
...
- PR #107 source `bfd698d4733ee45ff414049b0ee74acf58a2aef` merged as `16f9745282c44f306071e0b81e43ba05186830e9` after CI 34238059322 and Auto Release 34238176018 succeeded. Release **v0.3.5.67** has both assets; Setup installed the exact .67 release and the existing `test` world was rejoined as GM.
- Foundry remained **14.365** with PF2e **8.5.0**; provider settings and world data were preserved. No .67 generation acceptance is claimed yet; this entry records publication and installation state only.
...
- The entries below describe the reviewed follow-up that was published in PR #107 and installed as .67. No .67 generation acceptance is claimed yet; the version-specific native results above remain the only installed behavioral evidence.
