...
- PCs using the Remaster Player Core / Player Core 2 Bard, Cleric, Druid, Oracle, Sorcerer, Witch, or Wizard receive their class's base slots and casting mode. Prepared classes get a daily plan with real spell-slot references; spontaneous spells retain their selected heightened rank. Review empty slots, variable traditions (bloodline/patron), signature spells, and restricted subclass/feat bonuses such as divine font or curriculum. Unsupported/legacy classes still use a generic spontaneous approximation, flagged in preview. NPCs retain spontaneous-style entries.
